...
INSERT INTO "new_Inspector" ("createdAt", "id", "initials", "name", "updatedAt") SELECT "createdAt", "id", "initials", "name", "updatedAt" FROM "Inspector";
DROP TABLE "Inspector";
ALTER TABLE "new_Inspector" RENAME TO "Inspector";
