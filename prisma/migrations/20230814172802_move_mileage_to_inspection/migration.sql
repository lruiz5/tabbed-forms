...
INSERT INTO "new_Vehicle" ("active", "carrierName", "createdAt", "id", "licenseNum", "make", "unitNum", "updatedAt", "year") SELECT "active", "carrierName", "createdAt", "id", "licenseNum", "make", "unitNum", "updatedAt", "year" FROM "Vehicle";
DROP TABLE "Vehicle";
